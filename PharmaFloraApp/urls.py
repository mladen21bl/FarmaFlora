...
urlpatterns = [
    ...
    path('plants/<int:pk>/compounds/', views.compound_list_by_plant, name='compound_list_by_plant'),
    path('plant/<int:pk>/active_compound/<int:compound_pk>/', views.active_compound_detail, name='active_compound_detail'),
